#!/usr/bin/env python3
"""Optional speech task integration points for suite orchestration."""
...
def prepare_variant(task_cfg: Dict[str, Any], **_: Any) -> Dict[str, Any]:
    ...
    if not _deps_available():
        return _skip(
            "speech_owsm requires torch + numpy + coremltools; dependencies missing",
            "missing_dependency",
        )
    ...
    return {
        "status": "ok",
        "message": "speech_owsm preparation hook ready (benchmark implementation optional).",
    }
...
def run_bench(task_cfg: Dict[str, Any], **_: Any) -> Dict[str, Any]:
    ...
    return _skip(
        "speech_owsm bench is not implemented in this suite revision; provide preconverted assets to extend.",
        "not_implemented",
    )
...
def dump_computeplan(task_cfg: Dict[str, Any], **_: Any) -> Dict[str, Any]:
    ...
    return _skip(
        "speech_owsm compute plan dump is not implemented in this suite revision.",
        "not_implemented",
    )
